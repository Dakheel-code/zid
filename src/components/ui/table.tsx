...
const TableHeader = forwardRef<HTMLTableSectionElement, React.HTMLAttributes<HTMLTableSectionElement>>(
  ({ className, ...props }, ref) => (
    <thead ref={ref} className={cn('bg-bg-secondary [&_tr]:border-b', className)} {...props} />
  )
)
...
const TableFooter = forwardRef<HTMLTableSectionElement, React.HTMLAttributes<HTMLTableSectionElement>>(
  ({ className, ...props }, ref) => (
    <tfoot
      ref={ref}
      className={cn('border-t bg-bg-secondary font-medium [&>tr]:last:border-b-0', className)}
      {...props}
    />
  )
)
...
const TableRow = forwardRef<HTMLTableRowElement, React.HTMLAttributes<HTMLTableRowElement>>(
  ({ className, ...props }, ref) => (
    <tr
      ref={ref}
      className={cn(
        'border-b border-border transition-colors hover:bg-bg-secondary/50 data-[state=selected]:bg-bg-secondary',
        className
      )}
      {...props}
    />
...
const TableHead = forwardRef<HTMLTableCellElement, React.ThHTMLAttributes<HTMLTableCellElement>>(
  ({ className, ...props }, ref) => (
    <th
      ref={ref}
      className={cn(
        'h-12 px-4 text-right align-middle font-semibold text-fg-secondary [&:has([role=checkbox])]:pr-0',
        className
      )}
      {...props}
    />
...
const TableCell = forwardRef<HTMLTableCellElement, React.TdHTMLAttributes<HTMLTableCellElement>>(
  ({ className, ...props }, ref) => (
    <td
      ref={ref}
      className={cn('p-4 align-middle text-fg-primary [&:has([role=checkbox])]:pr-0', className)}
      {...props}
    />
  )
)
